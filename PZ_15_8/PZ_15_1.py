...
with sqlite3.connect('Zakazi.db') as con:
    ...
    cur.execute("INSERT INTO users VALUES (2, 'Товар 2', 'Заказчик2', '2022-05-16', 10, 15000)")
    ...
    cur.execute("INSERT INTO users VALUES (8, 'Товар 8', 'Заказчик3', '2022-07-18', 6, 75000)")
